...
Note _noteDeserialize(
  ...
  final object = Note(
    category: _NotecategoryValueEnumMap[reader.readByteOrNull(offsets[0])] ??
...
const _NotecategoryValueEnumMap = {
  0: CategoriesEnum.work,
  1: CategoriesEnum.school,
  2: CategoriesEnum.personal,
  3: CategoriesEnum.others,
};
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, CategoriesEnum, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
